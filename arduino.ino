...
// Wi-Fi credentials
const char* ssid = "ZanDen";    // nama Wi-Fi anda (SSID)
const char* password = "Diponegoro165";  // password Wi-Fi anda

// Firebase credentials
#define API_KEY "AIzaSyC-HcnPSw2oxBnA_yWOsfpVAHSce8N8UvU"    // Found in Project Settings > General
#define DATABASE_URL "https://testled-5c20f-default-rtdb.firebaseio.com/"  // From Realtime Database URL
#define USER_EMAIL "vincent@gmail.com"  // email user saat membuat database
#define USER_PASSWORD "vincent"    // password user yang telah didaftarkan
